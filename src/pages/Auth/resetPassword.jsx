    ...
    return (
        <div className="w-full min-h-screen md:flex">
            ...
            <div className="md:w-[40%] w-full min-h-screen bg-[url(https://s3-alpha-sig.figma.com/img/eb4e/b918/44e6350c01c34560f40f77de606e7121?Expires=1733702400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=q8qiibStLA7oGlsidbjujFs5zQ-tYRV4dkDH2nd9MLYXKp2ts8Cx9vRojSiscnL8LC~AQvNniSuD5CCe4JtmrzkF1id~TQ3In~upprgSjwhlZowQKF9Jj~QXxZcaV69MCHv5gNB73A0AzooE8Yww25u-aApLJprwM8DqSBa5mX9yTovjfApV~uRq9WML-Q0nTUvcd3--buLKv5nVZ9wIj1JNorHLXX8Pcfdc306EJbDA--ieZb2wPK3~Ow0OuzuDVxgORQ7H2C2~LLl1dLmia-SFaYiHqZg2hMwJeaW4cslbgxc75mHQVuF0w9gtTaFx0xpymtruRLM4EyV1L5rCCw__)] bg-cover flex flex-col justify-center px-[2rem] text-white">
                ...
                <br />
                <p>Masukkan email Anda yang terdaftar untuk mendapatkan kode verifikasi</p>
                <br />
...
const Slide = () => {
    ...
    const dataSileder = [
        { img: slide1, title: "Pusat Seni dan Budaya Jawa Timur", description: "Telusuri produk khas dari seniman dan pengrajin Jawa Timur." },
        { img: slide2, title: "Marketplace Lokal Pertama Di Jawa Timur", description: "Temukan berbagai macam produk lokal unggulan." },
        { img: slide3, title: "Nikmati Berbagai Macam Event Lokal", description: "Temukan berbagai macam event kesenian dan budaya." },
    ];
    ...
    return (
        <>
            <img src={dataSileder[currentIndex].img} alt="" width={400} loading="lazy" />
            <h2 className="text-center pt-4 text-3xl text-primary font-semibold">{dataSileder[currentIndex].title}</h2>
            <p className="text-center w-[60%]">{dataSileder[currentIndex].description}</p>
